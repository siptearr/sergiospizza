...
$ssq2 = "select * from nota where seccion_idseccion = (select idseccion from seccion where nombre = 'Clasificados') and estatus = 'activo' order by idnota desc limit 0,5";
$rs2 = mysql_query($ssq2,$conn);
session_start();
echo '<b><span class="Estilo2" style="font-family:&quot;Arial&quot;,&quot;sans-serif&quot;">Clasificados Gratis</span></b>
<hr>';

if(@$_SESSION["autentificado"] == "SI" && @$_SESSION["privilegios"] != "invitado")
{
	echo "<li class=\"top\" id=\"liclasificados\"><a href=\"javascript:insertanota('10');\" class=\"top_link\">Inserta Clasificado</a></li>";
}

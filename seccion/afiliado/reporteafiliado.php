...
if($filtro != ""){
    $querycontruido .= 'where a.idafiliado = '.$filtro.' and a.estatus<>\'inactivo\' ';
    $querycontruido .= 'group by a.id'.$catalogo.' ';
}
$querycontruido .= 'order by id'.$catalogo.' desc';
...
_HTML_;
/*
 * Icono de insertar atenciones al afiliado
 */   
    $tabla.=<<<_HTML_
            &nbsp;<a href="javascript:addservmed('atencion',
_HTML_;
    $tabla.= $arregloresultado[$base][0].",".$idusr;
    $tabla.=<<<_HTML_
);" ><img src="imagenes/addservmed.jpg" height="20" width="20" /></a>
_HTML_;
/*
 * Icono de insertar atenciones al afiliado
 */
/*
 * Icono de reporte en PDF
 */    
    $tabla.=<<<_HTML_
            <a href="javascript:window.open('pdf/reporte_afiliado.php?idregistro=
_HTML_;
    $tabla.= $arregloresultado[$base][0];
    $tabla.=<<<_HTML_
','_blank');" ><img src="imagenes/logopdf.jpg" height="20" width="15" /></a>
_HTML_;
/*
 * Icono de reporete en PDF
 */    
/*

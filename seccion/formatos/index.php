      ...
      switch($catalogo){
       case 'credenciales':
           echo '<a name="'.$catalogo.'"></a>
              <div id="catalogo_'.$catalogo.'" name="catalogo_'.$catalogo.'"><input type="button" value="Carga" onclick="javascript:carga_'.$catalogo.'">';
           echo '
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
			  ...
			  <label>
			    ...
			    <img src="seccion/formatos/credenciales/lupa2.jpg" width="25" height="15" onclick="xajax_buscar(document.form1.txt_Buscar.value)" />
			    </label>
                          </td>

...
<title><?php echo ucfirts($dominio) ?> - Catalogos</title>
<style type="text/css">
<!--
...
echo '<b><span class="Estilo2" style="font-family:&quot;Arial&quot;,&quot;sans-serif&quot;">Pagina de administracion de Catalogos</span></b>
<hr>';

if(@$_SESSION["login"] == true && @$_SESSION["privilegios"] != "administrador")
{
    $rs1 = mysql_query($sql1,$conn);

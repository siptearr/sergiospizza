...
// layout conf
// -----------
xcMonthNames=["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
xcMonthShortNames=["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"];
xcMonthPrefix="";
xcMonthSuffix="";
...
// names for days
xcWeekdayNames=["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado", "Domingo"];
xcWeekdayShortNames=["Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab", "Dom"];
xcWeekdayDisplay=["D", "L", "M", "Mi", "J", "V", "S", "D"];

// foot links
xcFootTags=["Hoy", "Limpiar", "Regresar", "Cerrar", "Reiniciar", "_Hoy_", "_Regresar_", "_Reiniciar_"];
...
xc_Close_the_calendar="Cerrar el calendario";

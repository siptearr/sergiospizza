...
//--------------------------------------------------------------------------------------------------------
  ...
  this.weekdays = ['Sab', 'Dom', 'Lun', 'Mar', 'Mier', 'Jue', 'Vie'];

  // months: must start with January
  this.months = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio',
                 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
  // error messages
  this.error = ['El año debe de ser entre 1 - 3999!', 'El Mes debe de ser entre 1 - 12!'];
...
//        html += ' onClick="document.location.href=\'' + link + '?date=' + date + '\'"';
        html += ' onClick="javascript:cronograma_dia(\'' + date + '\');tipodia();"';
//        html += ' onClick="javascript:cronograma_dia(' + date + ');"';

...
INSERT INTO `configuracion` VALUES ('2', '2016-09-15', 'general');
...
CREATE TABLE `usuario` (
  ...
  PRIMARY KEY (`idusuario`,`privilegios_idprivilegios`,`tipousuario_idtipousuario`),

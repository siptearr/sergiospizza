...
INSERT INTO `afiliado` VALUES ('3', '1115578965', 'Susana', 'Cisneros', 'Mercado', '1977-07-04', '789456', 'activo', '2', '11', '15', '1');
...
INSERT INTO `asignaciones` VALUES ('3', 'atencion', 'si', 'si', 'si', 'si', '1');
INSERT INTO `asignaciones` VALUES ('4', 'atencion', 'si', 'si', 'si', 'no', '3');
...
CREATE TABLE `atencion` (
  ...
  `motivopago` text,
  `estatus` varchar(45) DEFAULT NULL,
  `surtmed_idsurtmed` int(11) NOT NULL,
  ...
  PRIMARY KEY (`idatencion`,`surtmed_idsurtmed`,`pago_idpago`,`afiliado_idafiliado`,`servbrindados_idservbrindados`,`servegr_idservegr`,`tiposervbrindado_idtiposervbrindado`,`causes_idcauses`,`cie10_idcie10`,`cie9_idcie9`),
  ...
  KEY `fk_atencion_surtmed1_idx` (`surtmed_idsurtmed`),
  KEY `fk_atencion_pago1_idx` (`pago_idpago`),
  CONSTRAINT `fk_atencion_pago1` FOREIGN KEY (`pago_idpago`) REFERENCES `pago` (`idpago`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_atencion_surtmed1` FOREIGN KEY (`surtmed_idsurtmed`) REFERENCES `surtmed` (`idsurtmed`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Records of pago
-- ----------------------------
INSERT INTO `pago` VALUES ('1', 'No');
INSERT INTO `pago` VALUES ('2', 'Si');
...
-- ----------------------------
-- Table structure for `surtmed`
-- ----------------------------
DROP TABLE IF EXISTS `surtmed`;
CREATE TABLE `surtmed` (
  `idsurtmed` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idsurtmed`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of surtmed
-- ----------------------------
INSERT INTO `surtmed` VALUES ('1', 'Completo');
INSERT INTO `surtmed` VALUES ('2', 'Incompleto');

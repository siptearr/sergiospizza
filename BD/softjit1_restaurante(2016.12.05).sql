...
CREATE TABLE `orden` (
  ...
  CONSTRAINT `fk_orden_procion1` FOREIGN KEY (`procion_idporcion`) REFERENCES `porcion` (`idporcion`) ON DELETE NO ACTION ON UPDATE NO ACTION,
